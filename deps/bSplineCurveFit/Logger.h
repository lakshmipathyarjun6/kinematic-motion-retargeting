...
#define GTE_ASSERT(condition, exception, message)                              \
    if (!(condition))                                                          \
    {                                                                          \
        throw exception(std::string(__FILE__) + "(" +                          \
...
#define GTE_ASSERT_INDIRECT(condition, exception, file, function, line,        \
                            message)                                           \
    if (!(condition))                                                          \
    {                                                                          \
        throw exception(std::string(file) + "(" + std::string(function) +      \
...
#define LogError(message) GTE_ERROR(std::runtime_error, message);